...
public class DetailsFragment extends Fragment {
    ...
    //this is the method where you set up variables, etc.. Anything that DOESN'T involve the View hierarchy
    @Override
        ...
        parkViewModel.getSelectedPark().observe(this, new Observer<Park>() {
            ...
            public void onChanged(Park park) {
                ...
                for (int i = 0; i < park.getActivities().size(); i++) {
                    sb.append(park.getActivities().get(i).getName()).append(" | ");
                }
                ...
                opsString.append("Wednesday: ").append(park.getOperatingHours().get(0).getStandardHours().getWednesday()).append("\n")
                         ...
                         .append("Tuesday: ").append(park.getOperatingHours().get(0).getStandardHours().getTuesday());
                ...
                if(!TextUtils.isEmpty(park.getDirectionsInfo())){
                    ...
                    directions.setText(R.string.info_not_available);
                }
    ...
    //can assign the view variables here. do any graphical work here.
    @Override
